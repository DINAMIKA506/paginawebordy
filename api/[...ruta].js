...
//
//   Este archivo es la única función que queda en /api. Recibe todas
//   las peticiones y llama por dentro al manejador que corresponde.
...
module.exports = async function handler(req, res) {
  // Vercel entrega el camino pedido en req.query.ruta.
