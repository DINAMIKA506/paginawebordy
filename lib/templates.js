...
const TEMPLATES = {
  ...
  circulos333: {
    ...
    folders: [
      ["content", "Calendario de contenidos", "✦", "#f94446", ["Ideas", "En producción", "Programado", "Publicado"]],
      ["team", "Corresponsales y equipo", "◎", "#31aebb", ["Personas", "Asignaciones", "Materiales"]],
      ["library", "Biblioteca", "▣", "#4e4bf7", ["Recursos", "Documentos", "Referencias"]]
    ]
  },
  avvo: {
    label: "Avvo",
