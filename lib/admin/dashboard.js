  ...
  try {
    ...
    const users = profiles.map((profile) => {
      ...
      return {
        ...
        space_phrase: ocean.settings?.spacePhrase || "",
        welcome: ocean.settings?.welcome || "",
        primary: ocean.settings?.primary || "#4e4bf7",
        secondary: ocean.settings?.secondary || "#b1b1fc",
        surface: ocean.settings?.surface || "#f6f7fc",
        ink: ocean.settings?.ink || "#172052",
